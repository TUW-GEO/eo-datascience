...
Now let's also load monthly aggregated H SAF ASCAT SSM Z scores which we already prepared in notebook 1. For this exercise we will filter the data to have a comparable time range (up to the end of 2021) as we have for the SPEI data.
