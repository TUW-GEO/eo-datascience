---
title: Validation of Remotely Sensed Droughts
...
- Z scores are based on standardized anomalies derived from e.g., spaceborne microwave-retrieved surface soil moisture
...
Now let's also load monthly aggregated H SAF ASCAT surface soil moisture data which we already used in notebook 1. For this exercise we will filter the data to have a comparable time range (up to the end of 2021) as we have for the SPEI data.
