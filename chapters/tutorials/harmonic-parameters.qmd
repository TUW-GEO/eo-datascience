...
jupyter:
  kernelspec:
    display_name: harmonic-parameters
    language: python
    name: harmonic-parameters
...
timeseries_dc = xr.open_dataset(
    "simplecache::file:///home/mschobbe/Documents/projects/eo-datascience/notebooks/tutorials/sigma0_timeseries.zarr",
    engine="zarr",
    storage_options={"simplecache": {"cache_storage": "/tmp/fsspec_cache/file"}},
)
timeseries_dc
```
